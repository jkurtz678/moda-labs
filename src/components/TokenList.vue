        ...
        <el-card class="container-card">
            <template #header>
                ...
                <div style="display: flex; align-items: center; margin-top: 20px;">
                    <el-input v-model="search_filter" :prefix-icon="Search" placeholder="Search by artwork title or artist name"></el-input>
                    <el-select v-model="sort_order" placeholder="Sort by" style="margin-left: 10px;">
                        <el-option label="Sort by name" value="name"></el-option>
                        <el-option label="Sort by newest" value="date_submitted"></el-option>
                    </el-select>
                </div>
            </template>
...
const tokens = computed(() => {
    ...
    } else if (sort_order.value === "date_submitted") {
        return filtered_tokens.sort((a, b) => b.entity.created_at.seconds - a.entity.created_at.seconds);
    }
